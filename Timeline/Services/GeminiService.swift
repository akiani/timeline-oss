...
class GeminiService: ObservableObject {
    ...
    func generateContent(
        ...
        let modelName = PromptsConfiguration.modelName
        ...
        // Create the fixed model with an optional structured-response schema.
    ...
    /// Create generation configuration for structured JSON responses.
