...
### Key Dependencies
- Firebase Core & Firebase AI Logic (Gemini Developer API)
...
- `PromptsConfiguration.swift` centralizes all AI prompts and the fixed model name
- Every AI task uses the production `gemini-3.5-flash` model
- Model thinking is automatic; the app exposes no model or thinking controls
